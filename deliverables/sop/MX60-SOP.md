...
**35 items.** Generated from `deliverables/_control/master-register.csv` on 2026-09-19. **Do not edit this file** — edit the register and re-run `tools/build-register-views.py`.
...
8 of the 35 decisions block something. **"Blocking" is not one thing** —
