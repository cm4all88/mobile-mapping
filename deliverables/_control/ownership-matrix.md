...
|---|---|---|---|---|---|
| What a trajectory is; why everything depends on it | Manual §2 | ● | ref | ref | ref |
| How mobile mapping error behaves — range, correlation in time | Manual §3 | ● | — | ref | ref |
| The workflow end to end | Manual §4 | ● | ref | ref | ref |
| The data chain — `.mxdb`, SBET, TMX, RWCX; no MTA on MX60 | Manual §5 | ● | — | — | ref |
...
| Topic | Owner | Manual | SOP | Field | Office |
|---|---|---|---|---|---|
| MX60 architecture, sensors, configurations | Manual §7 | ● | ref | ref | ref |
| TMI, TBC, POSPac and the licensing gates | Manual §10 | ● | ref | ref | ref |
| LiDAR QC — what it is and needs | Manual §11 | ● | ref | — | ref |
| Battery Protect behaviour | Manual §7 | ● | — | ref | — |
...
| Topic | Owner | Manual | SOP | Field | Office |
|---|---|---|---|---|---|
| Why initialization works — what the static period and manoeuvres solve | Manual §13 | ● | — | ref | — |
| **How to initialize** | **Field §12** | ref | ref | ● | — |
| **That initialization is required** | **SOP §9** | — | ● | ref | — |
| Why the closing sequence exists | Manual §14 | ● | — | ref | — |
...
| **Update Scans — why registration does not move points** | **Manual §19** | ● | ref | — | ref |
| Calibration theory, site geometry | Manual §20 | ● | ref | ref | ref |
| **Calibration interval, triggers, currency** | **SOP §14** | ref | ● | ref | ref |
| **How to calibrate** | **Office §13** | ref | ref | — | ● |
| Registration theory; the three commands | Manual §21 | ● | ref | — | ref |
...
| Degraded GNSS — three remedies and what each costs | Manual §27 | ● | ref | ref | ref |
