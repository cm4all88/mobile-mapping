...
answered first. 10 rows, **9 distinct questions**.
...
| **delivery for a stated accuracy purpose** | D-2, D-16, V-4 | Work can be delivered, but not with an accuracy claim attached |
